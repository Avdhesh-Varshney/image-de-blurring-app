...
if __name__ == "__main__":
    model_deblur_architecture_path = 'Model/de-blur-cnn/deblur_CNN_architecture.json'
    model_deblur_weights_path = 'Model/de-blur-cnn/deblur_CNN.weights.h5'
    model_deblur_keras_path = 'Model/de-blur-cnn/deblur_CNN_model.keras'

    model_autoencoder_architecture_path = 'Model/autoencoder/autoencoder_model_architecture.json'
    model_autoencoder_weights_path = 'Model/autoencoder/autoencoder_model.weights.h5'
    model_autoencoder_keras_path = 'Model/autoencoder/autoencoder_model.keras'
    ...
    try:
        ...
        # Method - 3
        # model = saved_model.load('Model/autoencoder/autoencoder')
        # model = saved_model.load('Model/de-blur-cnn/deblur_CNN_model')
